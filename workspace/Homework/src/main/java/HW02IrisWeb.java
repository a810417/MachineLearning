...
@WebServlet("/HW02IrisWeb")
public class HW02IrisWeb extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		DataSource source;
		 ...
		 try {
			source = new DataSource("C:\\MachineLearning\\workspace\\Homework\\src\\main\\webapp\\data\\iris.arff");
...
//			System.out.println(data.toString()); // 印出 dataset
			...
			response.getWriter().write("Iris Class= "+data.classAttribute().value((int)label));
